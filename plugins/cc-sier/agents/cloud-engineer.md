...
## 成果物の保存先
- インフラ設計: `.companies/{org-slug}/infra/designs/{design-id}.md`
- IaC設計: `.companies/{org-slug}/infra/iac/{module-id}.md`
- セキュリティ設計: `.companies/{org-slug}/infra/security/{policy-id}.md`
