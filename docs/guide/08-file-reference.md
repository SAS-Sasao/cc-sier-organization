...
11. [Hook] session-boundary.sh が起動:
    11a. .interaction-log/ に区切り線追記
    11b. .session-summaries/ に統計 JSON 保存
    11c. GitHub Issue に投稿
    11d. skill-evaluator.sh が .task-log/ に reward 追記
